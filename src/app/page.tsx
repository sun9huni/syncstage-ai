...
export default function Home() {
  ...
  const handleLoadDemoTrack = () => {
    setAudioUrl("https://cdn.jsdelivr.net/gh/sun9huni/syncstage-ai@main/public/musics/demo_track.mp3");
    setPhase(1);
  };
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const audioRes = await fetch("https://cdn.jsdelivr.net/gh/sun9huni/syncstage-ai@main/public/musics/demo_track.mp3");
          ...
          <div className="max-w-lg w-full text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                K-pop 데모 음원을 업로드하면 Gemini 3 Flash가<br />
                네이티브 오디오 딥리스닝으로 곡의 텐션과 전개를 분석합니다.
              </p>
              <div className="flex justify-center gap-2 pt-2">
                <span className="text-[9px] px-2 py-1 bg-blue-900/40 border border-blue-700/30 text-blue-300 rounded-full font-mono">Gemini 3 Flash</span>
          ...
          <div className="w-full max-w-2xl bg-neutral-900 rounded-xl border border-neutral-800 shadow-2xl overflow-hidden">
            <div className="p-4 bg-gradient-to-r from-violet-900/50 to-fuchsia-900/50 border-b border-neutral-800 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-400 font-mono">gemini-3-flash-preview • native multimodal inference</p>
              </div>
            </div>
